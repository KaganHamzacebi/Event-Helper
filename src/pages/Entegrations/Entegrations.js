...
export default function Entegrations() {
    ...
    return (
        <div>
            <Helmet>
                ...
                />
                <meta name='keywords' content='Event, Discord, Raid, Meeting, Bot, WOW, World of Warcraft, Yes & No, Yes No, one click, Entegrations' />
