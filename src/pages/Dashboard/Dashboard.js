    ...
    useEffect(() => {
        if (guildSettings) {
            setMappedGuilds(guildSettings.map((item, index) => {
                ...
                return { label: item.name, icon: `https://discord.com/assets/3437c10597c1526c3dbd98c737c2bcae.svg`, value: item.id };
        ...
        <div className='flex w-full h-full'>
            ...
            <div className={`${isOpen ? '-translate-x-full' : ''} z-50 transform transition-transform duration-500 flex fixed flex-shrink-0 flex-col flex-nowrap sm:static w-full sm:w-72 h-full bg-home pt-6 p-5 shadow-md`}>
                ...
                </div>
                {
                    indexGuild == null ?
                        <div className='mt-6 transition-color duration-700'>
                            <div className={`w-full flex border h-14 border-gray-900 rounded pl-3.5 pr-8 bg-gray-700 opacity-10 animate-pulse`}>
                            </div>
                        </div>
                        :
                        <div className='mt-6'>
                ...
                <div className='mt-2'>
                    ...
                    <div className='flex flex-row items-center p-2 rounded group cursor-pointer'>
                        ...
                        <span className='ml-2 text-primary text-opacity-70 trainsition-all duration-500 group-hover:text-opacity-100'>Event List</span>
                    </div>
                    <div className='flex flex-row items-center p-2 rounded group cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="white">
                ...
                <div className='mt-2'>
                    ...
                    <div className='flex flex-row items-center p-2 rounded group cursor-pointer'>
                        ...
                        <span className='ml-2 text-primary text-opacity-70 trainsition-all duration-500 group-hover:text-opacity-100'>Status</span>
                    </div>
                    <div className='flex flex-row items-center p-2 rounded group cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="white">
                        ...
                        <span className='ml-2 text-primary text-opacity-70 trainsition-all duration-500 group-hover:text-opacity-100'>Purchase</span>
                    </div>
                    <div className='flex flex-row items-center p-2 rounded group cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="white">
                            <path d="M8 5a1 1 0 100 2h5.586l-1.293 1.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L13.586 5H8zM12 15a1 1 0 100-2H6.414l1.293-1.293a1 1 0 10-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L6.414 15H12z" />
                        </svg>
                        <span className='ml-2 text-primary text-opacity-70 trainsition-all duration-500 group-hover:text-opacity-100'>Transfer</span>
                    </div>
                </div>
                <div className='flex-grow'></div>
                {/* Acoount Settings */}
                <div className='border-t border-white border-opacity-40'></div>
                <div className='flex flex-row hover:bg-gray-700 py-3 px-2 rounded-lg items-center mt-2 cursor-pointer' onClick={() => history.push('/user_settings')}>
                    {
                        user && user.id &&
                        <img
            ...
            <div className='flex flex-col flex-grow'>
                ...
                <div className='bg-home-light h-20 flex flex-grow items-center shadow-md px-12'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 visible sm:hidden" viewBox="0 0 20 20" fill="white" onClick={() => setIsOpen(!isOpen)}>
