                ...
                <div className="container mx-auto px-6 2xl:px-40">
                    <Zoom triggerOnce>
                        ...
                        <div className='pb-14 pt-10 lg:pt-20 text-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-48 w-48 mx-auto" viewBox="0 0 20 20"
                                 fill="white">
                                <path
                            ...
                            <div className='flex flex-wrap'>
                                <div
                                    className="flex-grow sm:flex-grow-0 grid grid-cols-1 sm:grid-cols-2 sm:mx-auto gap-4">
                                    <button
                                    ...
                                    >
                                        <div className="m-auto p-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 mr-4 inline-block"
                    ...
                    <Zoom triggerOnce>
                        ...
                        <div className='grid lg:grid-cols-3 grid-cols-1 gap-4'>
                            ...
                            <div className='container rounded-2xl shadow-xl p-8 bg-home-grid'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mx-auto my-8"
