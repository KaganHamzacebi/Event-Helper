...
export default function Footer() {
    ...
    return (
        <div className='w-full border-t border-gray-700'>
            <div className='container p-6 2xl:px-40 grid grid-cols-1 lg:flex mx-auto'
                 style={{backgroundColor: '#1b1b1b'}}>
                <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 lg:h-8 my-auto -ml-2" viewBox="0 0 20 20"
                         fill="white">
                        <path
                    ...
                    <select defaultValue={language} onChange={(e) => setLanguage(e.target.value)}
                            className='ml-8 border border-gray-900 rounded pr-8 outline-none bg-title text-primary-light placeholder-opacity-30  transition duration-800 focus:ring-2 focus:ring-blue-600'>
                ...
                <div className='grid lg:flex grid-cols-1 justify-items-start mt-4 lg:mt-0 lg:m-auto'>
                    <button className='text-primary-light transition-color text-base mx-4 duration-700 hover:text-white'
