        ...
        <div className='w-full border-t border-gray-800 p-8' style={{ backgroundColor: '#1b1b1b' }}>
            <div className='flex text-center'>
                <div className='flex mx-auto gap-2'>
                    ...
                    <h1 className='text-primary-light text-base'>Tetherer - All rights reserved</h1>
                    <select defaultValue={language} onChange={(e) => setLanguage(e.target.value)} className='ml-4 border border-gray-900 rounded pr-8 outline-none bg-title text-primary-light placeholder-opacity-30  transition duration-800 focus:ring-2 focus:ring-blue-600'>
