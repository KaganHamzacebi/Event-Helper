...
export default function Tag({
    ...
    return (
        <div className='pl-2 mb-2 inline-block'>
            <div /* style={{ backgroundColor: color }} */ className='p-0.5 pl-2 pr-6 select-none bg-content hover:bg-gray-600 transition-color duration-500 text-primary text-sm rounded relative'>
                <span>{name}</span>
